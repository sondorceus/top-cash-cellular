...
TARGETS = [
    ...
    ("samsung-tablet", "galaxy-tab-s9-plus"),
    ("samsung-tablet", "galaxy-tab-s9"),
    ("samsung-tablet", "galaxy-tab-s9-fe-plus"),
    ("samsung-tablet", "galaxy-tab-s9-fe"),
    ("samsung-tablet", "galaxy-tab-s8-ultra"),
    ("samsung-tablet", "galaxy-tab-s8-plus"),
    ("samsung-tablet", "galaxy-tab-s8"),
