  ...
  return (
    ...
    >
      <div className="relative aspect-square bg-white/[0.03] flex items-center justify-center p-6">
        ...
        {l.photos.length > 1 && l.status === "listed" && (
          <span className="absolute bottom-3 right-3 inline-flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-bold bg-black/60 border border-white/15 text-[#dcdcdc]">
            <svg viewBox="0 0 24 24" className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2">
