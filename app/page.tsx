...
const CONDITIONS = [
  { id: "sealed", label: "Sealed", desc: "Factory sealed, never opened", multiplier: 1.12, icon: "📦", details: ["Still in factory original sealed packaging", "Plastic wrap or seal is intact and has not been tampered with", "Device has never been activated or powered on", "Must include original box with matching serial number", "Contains all original accessories unopened"] },
  ...
  { id: "verygood", label: "Very Good", desc: "Minimal use, barely noticeable wear", multiplier: 0.97, icon: "💎", details: ["Very light scratches or scuffs barely visible — no dents or dings", "Display is free of defects such as cracks, dead pixels, white spots, or burn-in", "Original battery above 80% capacity", "Powers on and functions 100% as intended", "Must be paid off and free of any financial obligations"] },
  { id: "good", label: "Good", desc: "Normal wear, fully functional", multiplier: 0.97, icon: "👍", details: ["Light to moderate signs of wear — visible scratches and/or minor dents", "Display is free of defects such as cracks, dead pixels, white spots, or burn-in", "Original battery above 80% capacity", "Powers on and functions 100% as intended", "Must be paid off and free of any financial obligations"] },
  { id: "fair", label: "Fair", desc: "Heavy wear, still functional", multiplier: 0.85, icon: "👌", details: ["Heavy signs of wear — deep scratches, dents, or scuffs", "Display is free of cracks but may have minor blemishes", "Battery may be below 80% capacity", "Powers on and functions as intended", "Must be paid off and free of any financial obligations"] },
