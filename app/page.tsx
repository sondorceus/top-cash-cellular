                ...
                <div className="flex gap-3 w-max animate-[marquee_28s_linear_infinite] hover:[animation-play-state:paused]">
                  {(() => {
                    ...
                    return [...devices, ...devices].map((d, i) => (
                      <button key={i} onClick={() => { setDeviceType(d.brand); setStep("model"); pushHistory("model"); }} className="flex-shrink-0 w-[260px] flex items-center justify-between bg-white/5 border border-white/10 rounded-xl px-4 py-3 hover:bg-white/10 hover:border-[#00c853]/40 transition cursor-pointer text-left active:scale-[0.98]">
          ...
          <div className="max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto px-4 pt-6 pb-8">
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-2 lg:grid-cols-3">
              ...
              {category === "desktops" && [
                ...
                { id: "alienware_desktop" as const, label: "Alienware", sub: "Aurora R13, R15, R16", brandIcon: <svg viewBox="0 0 40 40" className="w-10 h-10"><circle cx="20" cy="20" r="18" fill="#0d0d1a"/><ellipse cx="20" cy="17" rx="11" ry="9" fill="none" stroke="#00e5ff" strokeWidth="1.2"/><ellipse cx="15" cy="16" rx="2.5" ry="1.8" fill="#00e5ff" opacity="0.9"/><ellipse cx="25" cy="16" rx="2.5" ry="1.8" fill="#00e5ff" opacity="0.9"/><path d="M16 22 Q20 25 24 22" fill="none" stroke="#00e5ff" strokeWidth="0.8"/><line x1="20" y1="26" x2="20" y2="30" stroke="#00e5ff" strokeWidth="0.8"/></svg> },
          ...
          <section className="py-16 bg-[#0a0a0a] text-center">
            <div className="max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto px-4">
              <div className="bg-gradient-to-br from-[#00c853]/10 to-transparent border border-[#00c853]/20 rounded-3xl p-8">
                ...
                <button onClick={() => { setStep("category"); pushHistory("category"); requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: "instant" as ScrollBehavior })); }} className="bg-[#00c853] text-white px-10 py-4 rounded-2xl text-lg font-bold cursor-pointer hover:bg-[#00e676] transition active:scale-[0.98] shadow-lg shadow-[#00c853]/20">
                  Get Your Quote Now
                </button>
          ...
          <div className="max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto px-4 pt-6 pb-16">
            ...
            {page === "about" && <div className="animate-[fadeIn_0.3s_ease-out]">
              ...
              <div className="bg-[#00c853]/10 border border-[#00c853]/20 rounded-2xl p-6 text-center">
                ...
                <button onClick={() => { setPage("home"); setStep("category"); pushHistory("category"); requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: "instant" as ScrollBehavior })); }} className="bg-[#00c853] text-white px-8 py-3 rounded-2xl font-semibold cursor-pointer hover:bg-[#00e676] transition active:scale-[0.98]">
                  Get My Quote
                </button>
              </div>
