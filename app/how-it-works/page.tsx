...
const STEPS = [
  {
    ...
    body: "Pick your device, storage, and condition. We show you the dollar amount up-front — no waiting, no hidden deductions. Lock in the price for 14 days.",
  },
  {
    n: 2,
    icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4",
    title: "Ship it free",
    body: "We email a pre-paid FedEx label. Drop the box at any FedEx location. Insured up to your full quoted value, tracked end-to-end.",
  },
  {
    n: 3,
    ...
    <main className="min-h-screen flex flex-col bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-10 pb-16">
        ...
        <div className="bg-[#00c853]/10 border border-[#00c853]/30 rounded-2xl p-6 text-center">
          ...
          <Link href="/?ask=handoff" className="inline-block bg-[#00c853] text-[#0a0a0a] px-6 py-3 rounded-full font-semibold hover:bg-[#00e676] transition">Sell my device →</Link>
        </div>
      </div>
