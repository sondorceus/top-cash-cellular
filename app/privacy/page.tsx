...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-black text-[#0a0a0a] px-6 py-16 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-8">Privacy Policy</h1>
      <p className="text-sm text-gray-400 mb-8">Last updated: April 18, 2026</p>

      <div className="space-y-8 text-sm text-gray-300 leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-3">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-3">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-3">3. Data Sharing</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-3">4. Cookies</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#0a0a0a] mb-3">7. Security</h2>
