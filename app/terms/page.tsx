...
const SECTIONS: { h: string; p: string }[] = [
  ...
  { h: "2. Eligibility & ownership", p: "You must be 18 or older to sell to us. Devices must be legally owned by you — stolen, fraud-reported, activation-locked, account-locked, or financed-but-unpaid devices will be refused and may be reported to law enforcement. We may require a valid government-issued photo ID and an ownership attestation at handoff." },
