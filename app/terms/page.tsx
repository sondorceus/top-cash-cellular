...
const SECTIONS: { h: string; p: string }[] = [
  ...
  { h: "2. Eligibility & ownership", p: "You must be 18 or older to sell to us. Devices must be legally owned by you — stolen, fraud-reported, activation-locked, account-locked, or financed-but-unpaid devices will be refused and may be reported to law enforcement. When you submit, you confirm that you are 18 or older and the legal owner of the device with the right to sell it. We verify each device's IMEI/serial against blacklist and lost/stolen databases before payment." },
