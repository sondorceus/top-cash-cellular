      ...
      <div className="max-w-2xl mx-auto px-4 pt-10 pb-16">
        ...
        {submitted ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
            ...
            <p className="text-xs text-[#dcdcdc] text-center">Or email us a list at <a href="mailto:CustomerService@topcashcells.com" className="text-white hover:text-[#00c853] transition">CustomerService@topcashcells.com</a> for the fastest response.</p>
          </div>
        )}
      </div>
    </main>
