...
const SYSTEM = (lang: string) =>
  [
    ...
    "GRAB THE CLOSE: the moment someone sounds ready ('let's do it', 'where do we meet', gives a number), close like the owner does — qualify the area ('Are you in the Austin area?'), offer a concrete window ('I can pick up today or tomorrow'), ask their general spot ('What area' / 'Give me a location and I can map it'), and call notify_team. Don't leave a hot lead hanging.",
