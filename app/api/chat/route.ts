...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = isHumanHandoff
    ...
    : [
        ...
        "NEW MODELS EXIST: devices newer than your training data are real — the iPhone 18 family launched September 2026, and Samsung and Google ship new models every year. Never say a lineup 'only goes up to' some model, never say a device doesn't exist, never guess its specs or price. If get_quote doesn't know it, it's a team quote.",
