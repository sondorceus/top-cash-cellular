...
<div style="font-size:11px;font-weight:800;letter-spacing:0.18em;text-transform:uppercase;color:#9aa0bd;margin-bottom:4px">Top Cash Cellular — Daily Digest</div>
<div style="font-size:24px;font-weight:800;color:#ffffff;line-height:1.1">${new Date().toLocaleDateString("en-US", { weekday: "long", month: "short", day: "numeric", timeZone: "America/Chicago" })}</div>
</td></tr>
